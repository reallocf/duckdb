with joins1 as (
  SELECT
      partsupp.rowid as partsupp_rowid2,
      supplier.rowid as supplier_rowid2,
      nation.rowid as nation_rowid2,
      region.rowid as region_rowid2,
      ps_partkey,
      ps_supplycost
  FROM
      partsupp,
...
SELECT
    ...
    group1.ps_partkey as group1_ps_partkey,
    s_acctbal,
    s_name,
    n_name,
    p_partkey,
...
from joins2, joins1 where group1_ps_partkey=ps_partkey;
