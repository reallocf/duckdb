...
#ifdef LINEAGE
	lineage_op->Capture(move(lstate.ht->sink_per_chunk_lineage), LINEAGE_SINK);

	lineage_op->CaptureAggregateDataChunk(GetName(), context.client, aggregate_input_chunk);
#endif
}
